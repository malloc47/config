# Copied from
# https://github.com/NixOS/nixpkgs/blob/025c2abd08de80609b961c8c8176a2be390a6d88/pkgs/development/tools/build-managers/leiningen/default.nix
# to get latest version of leiningen; can be removed once on 19.03
